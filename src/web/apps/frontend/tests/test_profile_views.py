"""
Profile view tests: GET rendering, POST update, unauthenticated redirect.

Tests migrated from test_frontend_views.py (profile section), plus new
coverage for unauthenticated access, customer profile GET, and double-space
name handling via split(None, 1).
"""
